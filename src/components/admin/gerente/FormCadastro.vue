...
<script>
import {formGerente} from '../../../services/admin.service'
    ...
    async enviar(){
      try {
        if(this.$refs.form.validate()){
          ...
          await formGerente(payload)
          
          this.dialog.ativar = true
          this.dialog.text = "Gerente salvo com Sucesso"
        ...
        this.dialog.ativar = true
        this.dialog.text = "Erro ao salvar Gerente"
